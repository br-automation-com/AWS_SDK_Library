...
void sample(unsigned long param) {
	...
	//	int32_t i = 0;
		...
		strcpy(HostAddress,AWS_IOT_MQTT_HOST);
	...
	//	char *pJsonStringToUpdate;
		...
		char rootCA[256 + 1];
		char clientCRT[256 + 1];
		char clientKey[256 + 1];
		char CurrentWD[256 + 1] = "";
		char cafileName[256]; strcpy(cafileName,AWS_IOT_ROOT_CA_FILENAME);
		char clientCRTName[256]; strcpy(clientCRTName,AWS_IOT_CERTIFICATE_FILENAME);
		char clientKeyName[256]; strcpy(clientKeyName,AWS_IOT_PRIVATE_KEY_FILENAME);
