...
#define iot_shadow_get_request_json _shadow_get_request_json 
void _shadow_get_request_json(char *pJsonDocument);
#define iot_shadow_delete_request_json _shadow_delete_request_json 
void _shadow_delete_request_json(char *pJsonDocument);
