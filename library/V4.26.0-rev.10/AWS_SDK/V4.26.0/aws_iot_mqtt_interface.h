 ...
 */
#define aws_iot_is_autoreconnect_enabled _is_autoreconnect_enabled
bool _is_autoreconnect_enabled(void);
 ...
 */
#define aws_iot_mqtt_autoreconnect_set_status _mqtt_autoreconnect_set_status
IoT_Error_t _mqtt_autoreconnect_set_status(bool value);
